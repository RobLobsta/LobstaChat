...
@Composable
fun CreatePersonaDialog(viewModel: PersonasViewModel) {
    var personaName by remember { mutableStateOf("") }
    var systemPrompt by remember { mutableStateOf("") }
    var showCreatePersonaDialog by remember { viewModel.showCreatePersonaDialogState }
    ...
    LaunchedEffect(showCreatePersonaDialog) {
        personaName = ""
        systemPrompt = ""
        selectedModel = null
    }
        ...
        Surface {
            Dialog(onDismissRequest = {
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(R.string.persona_create_persona_title),
                    ...
                    Text(
                        modifier =
                            Modifier
                                ...
                                .padding(8.dp),
                        text = if (selectedModel == null) stringResource(R.string.persona_create_persona_select_model) else selectedModel!!.name,
                    )
                    ...
                    OutlinedButton(
                        enabled =
                            personaName.isNotBlank() && systemPrompt.isNotBlank() && selectedModel != null,
                        onClick = {
                        ...
                        Text(stringResource(R.string.persona_create_persona_add))
                    }
                }
            }
        }
